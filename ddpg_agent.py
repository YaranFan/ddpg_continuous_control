...
class Agents():
    ...
    def __init__(self, state_size, action_size, n_agents, random_seed=7, device='cpu',
        buffer_size=100000, batch_size=128, gamma=0.99, tau=0.001, lr_actor=0.0001, lr_critic=0.001, weight_decay=0):
